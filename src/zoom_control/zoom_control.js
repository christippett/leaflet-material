...
export var MaterialZoomControl = L.Control.Zoom.extend({
  onAdd: function (map) {
    ...
    this._zoomOutButton = this._createMaterialButton(
      "leaflet-zoom-out-mdl",
      options.zoomOutText,
...
export function materialZoomControl(options) {
