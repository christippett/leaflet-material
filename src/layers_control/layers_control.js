...
export var MaterialLayersControl = L.Control.Layers.extend({
  options: {
    collapsed: true,
    position: "topright",
    autoZIndex: true,
  ...
  _initLayout: function () {
    ...
    var link = (this._layersLink = this._createMaterialButton(
      buttonId,
      "layers",
      "Layers",
      container
  ...
  _createRadioElement: function (name, checked) {
    var radioHtml =
      '<input type="radio" class="mdl-radio__button" name="' +
      name +
      '"' +
...
export function materialLayersControl(baseLayers, overlays, options) {
